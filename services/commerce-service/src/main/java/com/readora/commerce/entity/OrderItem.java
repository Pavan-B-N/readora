...
public class OrderItem {
    ...
    // Creates a line item, computing its line total from the snapshotted unit price and quantity.
    public OrderItem(
    ...
    // Id of the purchased book.
    public UUID getBookId() {
        return bookId;
    }

    // Book title frozen at purchase time.
    public String getTitleSnapshot() {
        return titleSnapshot;
    }

    // ISBN frozen at purchase time.
    ...
    // Physical vs virtual fulfillment for this item.
