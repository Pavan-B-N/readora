...
// REST endpoints for the caller's shopping cart.
@Tag(name = "Cart")
@RestController
...
public class CartController {
    ...
    // Wires the cart service.
    public CartController(CartService cartService) {
        this.cartService = cartService;
    }

    // Gets the caller's cart contents.
    @Operation(
    ...
    // Sets a cart line item's absolute quantity; 0 removes it.
    @Operation(
