...
public interface OrderRepository extends JpaRepository<Order, UUID> {
    ...
    // Looks up an order by its checkout idempotency key, for replay detection.
    ...
    // An order scoped to its owning user, for ownership checks.
    ...
    // An order scoped to its fulfilling store, for admin ownership checks.
