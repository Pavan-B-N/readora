...
public class AdminOrderController {
    ...
    // Wires the admin order service.
    public AdminOrderController(AdminOrderService adminOrderService) {
        this.adminOrderService = adminOrderService;
    }

    // Lists cancelled/returned orders at the caller's store.
    @Operation(
    ...
    // Lists only pending returns/cancellations awaiting review, optimised for the default admin view.
    @Operation(
    ...
    // Lists returns/cancellations the admin has already reviewed.
    @Operation(
    ...
    // Gets one return/cancellation case's full detail by id.
    @Operation(
    ...
    // Records a review note and, if a decision is given, approves or rejects the return.
    @Operation(
    ...
    // Sends a return chat message as the admin.
    @Operation(
