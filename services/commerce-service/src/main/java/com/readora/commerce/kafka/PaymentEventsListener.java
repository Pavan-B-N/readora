...
// Consumes payment/refund lifecycle events off Kafka and drives the corresponding order/return state transitions.
@Component
public class PaymentEventsListener {
    ...
    // Wires the fulfillment and return services plus the JSON mapper for event payloads.
    ...
    // Payment was captured — advances the order past PAID.
