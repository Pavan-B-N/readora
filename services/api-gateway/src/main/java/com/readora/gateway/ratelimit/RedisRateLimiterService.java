...
// Token-bucket rate limiter backed by Bucket4j's distributed Redis state; buckets refill continuously rather than resetting all-at-once, so callers can't burst past the limit at a window boundary.
@Component
public class RedisRateLimiterService {

    private final AsyncProxyManager<String> proxyManager;

    // Wires in the Bucket4j proxy manager used to build and consume buckets.
