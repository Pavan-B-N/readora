...
// Internal, gateway-secret-protected endpoints for looking up admin-to-store assignments.
@Tag(name = "Internal")
@RestController
...
public class InternalAdminController {
    ...
    // Returns the store id an admin manages, if any.
    @Operation(
    ...
    // Returns the admin user id assigned to a store, if any.
    @Operation(
