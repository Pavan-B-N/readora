...
// Forwards the caller's userId as a freshly minted internal JWT — user-service validates it itself and extracts the userId, the same as it would for a real user token.
@Component
public class UserClient {
    ...
    // Fetches the given user's wallet info.
