...
// Full public detail view of a book, including availability, virtual edition and review summary.
public record BookDetailResponse(
    ...
    // A book's author, as shown on its detail page.
    ...
    // status is one of IN_STOCK, OUT_OF_STOCK (physical, at the caller's store, sold out), NOT_AVAILABLE_AT_STORE (physical, but stocked at a different store), or NO_PHYSICAL_EDITION (virtual-only, no physical stocking at all).
