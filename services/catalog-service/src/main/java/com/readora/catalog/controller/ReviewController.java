...
// REST endpoints for reading and writing a book's reviews.
@Tag(name = "Reviews")
@RestController
...
public class ReviewController {
    ...
    // Creates or updates the caller's own review for this book.
    @Operation(
    ...
    // Deletes the caller's own review for this book, if any.
    @Operation(
