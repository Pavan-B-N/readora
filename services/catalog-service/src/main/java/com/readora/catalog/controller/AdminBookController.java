...
// Admin REST endpoints for creating and editing books, their inventory, and their virtual editions.
...
public class AdminBookController {
    ...
    // Overwrites an existing book's editable fields.
    @Operation(
    ...
    // Sets a book's absolute stock levels.
    @Operation(
    ...
    // Creates or updates a book's virtual edition.
    @Operation(
    ...
    // Deactivates a book's virtual edition, if one exists.
    @Operation(
