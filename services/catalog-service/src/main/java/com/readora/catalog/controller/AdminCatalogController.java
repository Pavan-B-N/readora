...
// Admin REST endpoints for managing categories, publishers, and authors.
...
public class AdminCatalogController {
    ...
    // Wires in the admin catalog service.
    ...
    // Overwrites an existing category's fields.
    @Operation(
    ...
    // Deletes a category, blocked while any book still references it.
    @Operation(
    ...
    // Overwrites an existing author's fields.
    @Operation(
    ...
    // Deletes an author, blocked while any book still credits them.
    @Operation(
