...
// Internal, service-to-service-only REST endpoint for reserving stock during checkout.
@Tag(name = "Internal")
@RestController
...
public class InternalInventoryController {
    ...
    // Wires in the inventory service.
    public InternalInventoryController(InventoryService inventoryService) {
        this.inventoryService = inventoryService;
    }

    // Atomically checks and reserves stock for every requested item, called by commerce-service during checkout.
    @Operation(
