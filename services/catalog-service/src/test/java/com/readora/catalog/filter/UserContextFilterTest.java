...
class UserContextFilterTest {
    ...
    private final UserContextFilter filter = new UserContextFilter(
            new SecurityProperties(List.of("/internal/**", "/api/v1/books", "/api/v1/books/*")),
    ...
    @Test
    void reviewsPath_getWithoutAuth_isAllowedThroughTheNarrowExemption() throws Exception {
    ...
    @Test
    void reviewsPath_postWithoutAuth_isRejected() throws Exception {
