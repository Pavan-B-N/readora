...
// Persists notifications and pushes them live to connected clients over WebSocket.
@Service
public class NotificationService {
    ...
    // Wires in the repository and the STOMP messaging template.
    ...
    // Lists a user's notifications, newest first, paginated.
    ...
    // Marks one of a user's notifications read.
    @Transactional
    ...
    // Maps the entity to its API response shape.
