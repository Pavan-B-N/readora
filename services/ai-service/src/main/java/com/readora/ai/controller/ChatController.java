...
// REST endpoint for streaming chat with the AI assistant.
@Tag(name = "AI Chat")
@RestController
...
public class ChatController {
    ...
    // Injects the chat service.
    public ChatController(ChatService chatService) {
        this.chatService = chatService;
    }

    // Sends a message to the assistant and streams the reply back as server-sent events.
    @Operation(
