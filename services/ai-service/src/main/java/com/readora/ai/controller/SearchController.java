...
// REST endpoint for semantic (embedding-based) catalogue search.
@Tag(name = "AI Search")
@RestController
...
public class SearchController {
    ...
    // Injects the search service.
    public SearchController(SearchService searchService) {
        this.searchService = searchService;
    }

    // Embeds the query and returns the nearest books by cosine similarity.
    @Operation(
