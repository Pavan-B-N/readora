...
// Listens for book upserts and triggers embedding of the affected book.
@Component
public class BookEventsListener {
    ...
    // Wires the embedding service and JSON mapper used to handle incoming events.
    public BookEventsListener(EmbeddingService embeddingService, ObjectMapper objectMapper) {
        this.embeddingService = embeddingService;
        this.objectMapper = objectMapper;
    }

    // Deserializes a book-upserted event and (re)embeds that book.
