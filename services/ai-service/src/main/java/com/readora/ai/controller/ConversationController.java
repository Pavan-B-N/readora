...
// REST endpoints for browsing the caller's saved assistant conversations.
...
public class ConversationController {
    ...
    // Injects the conversation service.
    public ConversationController(ConversationService conversationService) {
        this.conversationService = conversationService;
    }

    // Lists the caller's saved conversations, newest first.
    @Operation(
    ...
    // Returns one conversation's full message history, oldest first.
    @Operation(
