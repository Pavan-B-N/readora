...
// Admin-only endpoints for triggering and monitoring catalogue embedding backfills.
...
public class AdminEmbeddingController {
    ...
    // Lists recent backfill jobs, newest first.
    @Operation(
    ...
    // Fetches one backfill job by id.
    @Operation(
    ...
    // Lists the books a backfill job has embedded so far, newest first.
    @Operation(
