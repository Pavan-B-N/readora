...
public class SecurityConfig {
    ...
    // Wires the filters and properties this security config assembles into the filter chain.
    ...
    // CSRF disabled — this is a stateless JSON API, not browser-form-based. Filter order: GatewaySecretFilter, then CorrelationIdFilter, then JwtAuthenticationFilter.
    @Bean
