...
/**
 * Rejects any request that didn't come through api-gateway or another internal service — same
 * shared secret used across every Readora service (see auth-service's GatewaySecretFilter).
 */
@Component
