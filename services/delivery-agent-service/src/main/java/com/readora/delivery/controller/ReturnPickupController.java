...
public class ReturnPickupController {
    ...
    // Lists the caller's own claimed return pickups, most recent first.
    ...
    // Returns a pickup plus the order's full delivery detail, including the shipping address.
    @Operation(
    ...
    // Claims an unassigned return pickup for the caller; first come, first served.
    @Operation(
    ...
    // Marks a claimed pickup as on the way.
    ...
    // Marks a claimed pickup's book as collected.
