...
import com.readora.delivery.security.JwtService;
 ...
 * CurrentUserContext with the caller's user id and roles — actual authorization (which routes
 * require an authenticated caller, and the DELIVERY_AGENT gate) is enforced separately by
 * UserContextFilter, which runs after this one.
 */
@Component
