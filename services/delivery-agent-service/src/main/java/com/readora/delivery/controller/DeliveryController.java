...
public class DeliveryController {
    ...
    // Wires in the delivery and agent-stats services.
    ...
    // Returns the caller's lifetime completed-deliveries, completed-returns, and earnings stats.
    @Operation(
    ...
    // Toggles the caller on/off duty; off-duty agents stop seeing new queue orders but keep access to what they've already claimed.
    @Operation(
    ...
    // Lists unassigned orders in the caller's store's shared claim queue.
    @Operation(
    ...
    // Lists the caller's own claimed deliveries, most recent first.
    ...
    // Returns an assignment plus the order's full delivery detail, including the shipping address.
    @Operation(
    ...
    // Claims an unassigned order for the caller; first come, first served.
    @Operation(
    ...
    // Marks a claimed order out for delivery.
    ...
    // Marks a claimed order delivered.
