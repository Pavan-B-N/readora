...
/** A single selectable entry in a Combobox's dropdown. */
...
/** Searchable dropdown select supporting single or multi-value selection, keyboard navigation, and optional inline creation of new options. */
