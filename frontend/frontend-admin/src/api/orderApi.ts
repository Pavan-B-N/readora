...
/** Fetches all admin-visible orders, unfiltered by review status. */
...
/** Fetches a single order/return's detail. */
...
/** Fetches the message thread for a return. */
...
/** Posts a new message to a return's message thread. */
