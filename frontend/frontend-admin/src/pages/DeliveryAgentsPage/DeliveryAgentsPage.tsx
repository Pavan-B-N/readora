...
/** Maps an agent's active-work status to the badge color variant used to display it. */
...
/** Roster of delivery agents with on-duty status and current work, polling for near-live updates. */
