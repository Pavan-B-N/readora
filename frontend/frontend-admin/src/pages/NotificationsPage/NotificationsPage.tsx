...
/** Formats an ISO timestamp as a short relative-time string ("just now", "5m ago", etc). */
...
/** Paginated notification inbox with unread filtering, mark-as-read on click, and mark-all-read. */
