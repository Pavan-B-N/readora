...
/** Formats a SCREAMING_SNAKE_CASE status code as human-readable title case. */
...
/** Maps a return/cancellation status to the badge color variant used to display it. */
...
/** Maps a refund status to the badge color variant used to display it. */
...
/** True when a case is a fresh return request, or a cancellation an admin hasn't reviewed yet. */
...
/** One clickable row in the returns list — order summary with status/refund badges, highlighted when it needs review. */
...
/** Paginated list of cancelled/returned orders, split into pending-review and reviewed tabs. */
