...
/** Maps the fetched book detail into editable form state, normalizing nulls to empty strings. */
...
/** Admin book detail page — read-only review with per-section inline editing for details, classification, and pricing. */
