...
/** Multi-step wizard for creating a new book — details, classification, then contents/review — before handing off to the detail page for stock/virtual edition setup. */
