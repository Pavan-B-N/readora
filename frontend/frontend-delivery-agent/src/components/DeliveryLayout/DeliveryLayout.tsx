...
/** The app shell for authenticated routes — header with duty toggle/nav/logout, plus an Outlet for the current page. */
export function DeliveryLayout() {
  ...
  const onToggleDuty = async () => {
    ...
    try {
      ...
      // e.g. trying to go off duty with an active delivery/pickup still in progress — the backend is the source of truth here, this just surfaces its 409 message.
