...
/** The app's route tree — public routes, a protected-route subtree requiring auth, and a catch-all 404. */
export const router = createBrowserRouter([
  {
    element: <SiteLayout />,
    // Catches render/loader exceptions thrown anywhere under SiteLayout, keeping the header/nav chrome rather than falling all the way out of it; a plain unmatched URL (no route pattern matches) is handled below by the "*" route instead.
