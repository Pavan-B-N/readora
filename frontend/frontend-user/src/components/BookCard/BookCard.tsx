...
/** A catalog book tile — cover, title, rating, price, and either "Read now" (owned virtual), a quantity stepper (already in cart), or an add-to-cart button, plus a wishlist toggle. */
