...
/** Header search input with a debounced autocomplete dropdown — shows live book suggestions while typing, or recent search history when the query is too short/empty, with full keyboard navigation. */
