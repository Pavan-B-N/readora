...
/** Floating chat launcher/panel for the book assistant — hidden on the full-page assistant route, resumes the latest conversation on load, and lets a signed-out user see the prompt but not send messages. */
