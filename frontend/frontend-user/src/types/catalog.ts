/** Compact book listing used in search results, grids, and rails. */
...
/** Author reference used for filter dropdowns and listings. */
...
/** Full book record shown on the PDP, with authors, availability, and virtual-edition pricing. */
...
/** Minimal book shape used by the search-bar autocomplete dropdown. */
...
/** Card shape for the "Related reads" rail on the PDP. */
...
/** A category tree node with nested children, flattened by callers like useCatalogFilters for the sidebar. */
...
/** A physical store location — the unit customers pick as their delivery source. */
