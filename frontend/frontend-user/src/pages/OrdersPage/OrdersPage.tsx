...
/** Stacked cover thumbnails for an order card — shows up to MAX_VISIBLE_COVERS, collapsing the rest into a "+N" chip. */
...
/** List of the caller's orders, each linking to its detail page; live status badges refresh on incoming order-status notifications. */
export function OrdersPage() {
  ...
  // A status push for any order on this page should update its badge immediately, not just tick up the bell's unread count.
