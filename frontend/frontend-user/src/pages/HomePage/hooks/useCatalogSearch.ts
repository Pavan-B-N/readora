  ...
  useEffect(() => {
    ...
    searchBooks({
      ...
      .then((result) => {
        ...
        // Stable partition: recommended-for-you titles surface first, everything else follows in the order the backend returned it — no separate "Recommended" rail, this is it.
